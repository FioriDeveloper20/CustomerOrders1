sap.ui.define([
	...
	return BaseObject.extend("com.exercises.model.GroupSortState", {
		 ...
		 * @alias com.exercises.model.GroupSortState
		 */
		...
		/**
		 * Sorts by PARTNER.PARTNERID, or by GROSSAMOUNT
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GROSSAMOUNT") {
				...
				this._oViewModel.setProperty("/sortBy", "PARTNER.PARTNERID");
			}
