sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/exercises/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.exercises.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/exercises/localService/mockserver"], function (mockserver) {
